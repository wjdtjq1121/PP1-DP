...
public class MainTest {
	...
	public void testMain() {
		...
		// String[] args = {"/Users/han/desktop/java/project3_practiveone/techjobs-oo-master","data/FirstSmalljavaProject.arff"};
		...
		///Users/han/desktop/java/project3_practiveone/techjobs-oo-master
		// /Users/han/desktop/java/project3_practiveone/java
	...
	public void testForTasks2() {
		...
		String[] args1 = {"/Users/han/desktop/java/project3_practiveone/techjobs-oo-master","data/FirstSmalljavaProject.arff"};
		Main.main(args1);
		
	}
	
	@Test
	public void testForTasks2AnotherOne() {
		// TASK2 TODO GitHub에서 작은 규모의 자바 프로젝트를 2개를 찾아, arff파일을 생성하시오. 파일이름은 [project이름].arff data디렉터리에 저장되게 하고
		// 생성이 된 후 commit/push해야 함.
		// 위 test main을 참고하여 실행하면 됨.
		String[] args2 = {"/Users/han/desktop/java/project3_practiveone/java","data/SecondSmalljavaProject.arff"};
		Main.main(args2);
